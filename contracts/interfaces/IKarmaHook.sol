...
interface IKarmaHook {
    ...
    // note: original base IKarmaHook deployment is missing these functions but
    // the IKarmaLpFeeConversion locker needs them
