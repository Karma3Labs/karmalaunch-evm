...
abstract contract KarmaHook is BaseHook, Ownable, IKarmaHook {
    ...
    mapping(PoolId => bool) internal karmaIsToken0;
    ...
    function _runMevModule(
        ...
        if (
            ...
            bool disableMevModule = IKarmaMevModule(mevModule[poolKey.toId()]).beforeSwap(
                poolKey, swapParams, karmaIsToken0[poolKey.toId()], mevModuleSwapData
            );
