...
import {KarmaHook} from "./KarmaHook.sol";

import {IKarmaHookDynamicFee} from "./interfaces/IKarmaHookDynamicFee.sol";
...
contract KarmaHookDynamicFee is KarmaHook, IKarmaHookDynamicFee {
    ...
    constructor(address _poolManager, address _factory, address _weth)
        KarmaHook(_poolManager, _factory, _weth)
    {}
